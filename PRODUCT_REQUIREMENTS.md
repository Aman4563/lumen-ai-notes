...
to Balanced. Measured latency/token/energy display, app authentication outside the
single-learner trusted-LAN scope, and trusted-HTTPS physical-iPhone model evidence
remain open.
